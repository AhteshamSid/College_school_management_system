        ...
        def __init__(self, *args, **kwargs):
            ...
            if 'upazilla' in self.data:
                try:
                    ...
                    self.fields['upazilla'].queryset = models.Upazilla.objects.filter(district_id=district_id).order_by(
                        'name')
            ...
            if 'union' in self.data:
                try:
                    ...
                    self.fields['union'].queryset = models.Union.objects.filter(upazilla_id=upazilla_id).order_by(
                        'name')
                except (ValueError, TypeError):
                    pass
            elif self.instance.pk:
